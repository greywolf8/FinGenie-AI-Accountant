...
import { X, AlertCircle, Info, CheckCircle, Shield, User } from "lucide-react"
                  ...
                  <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-md mb-4 flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-orange-700 dark:text-orange-400 mt-1">
                        Your wallet address will be used to create a unique decentralized identifier (DID) for secure,
                        passwordless login.
                      </p>
                    </div>
                  </div>
