        ...
        <section className="container mx-auto py-16 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <FeatureCard
              ...
              description="Your data is securely stored on the blockchain using Arweave + Bundlr technology for permanent, censorship-resistant storage."
            />
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
                ...
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Arweave + Bundlr Storage</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Your data is permanently stored on the blockchain using Arweave and Bundlr technology, ensuring
